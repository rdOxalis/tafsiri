...
- 30 new tests (125 total, was 95), including three that drive the real `tesseract` binary against fixture images and skip themselves where it is not installed.
